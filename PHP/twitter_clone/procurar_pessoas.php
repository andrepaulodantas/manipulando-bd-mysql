				...
				$('#btn_procurar_pessoa').click(function(){
					...
					if($('#nome_pessoa').val().length > 0){
						$.ajax({
							url: 'get_pessoas.php',
							method: 'post',
							data:  $('#form_procurar_pessoas').serialize(), //recuperar dados do formulário
							success: function(data) {
								$('#pessoas').html(data);//caso haja sucesso na verificação da pessoa, será colocado dentro da div
								//alert(data);
                                $('.btn_seguir').click(function(){
                                  var id_usuario =  $(this).data('id_usuario');//recuperar a informação do elemento clicado
