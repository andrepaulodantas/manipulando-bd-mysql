<?php
	...
	$erro_usuario 	= isset($_GET['erro_usuario']) ? 	$_GET['erro_usuario'] : 0; //if ternário
	    ...
	    <div class="container">
	    	...
	    	<div class="col-md-4">
				...
				<form method="post" action="registra_usuario.php" id="formCadastrarse">
					...
					<div class="form-group">
						<input type="cpf" class="form-control" id="cpf" name="cpf" placeholder="CPF" required="requiored">
						<?php
